...
const messages = [
  "pixel-art",
  "hi cedric!🧸",
  "this is the first website I made myself!🕺 of course, with the help of the internet hehe",
...
function startPostBlackoutSequence() {
  const sequence = [
    ...
    { id: 'sequence-5', duration: 5000 }, // Extinguished candle
    { id: 'sequence-6', duration: 5000},
  ];
